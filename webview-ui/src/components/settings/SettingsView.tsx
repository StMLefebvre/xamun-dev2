...
const SettingsView = ({ onDone }: SettingsViewProps) => {
	...
	const handleSubmit = () => {
		...
		if (!apiValidationResult && !modelIdValidationResult) {
			...
			vscode.postMessage({ type: "setIsDebugMode", value: isDebugMode })
			onDone()
		}
	}
		...
		<div
			...
			<div
				...
				<div style={{ marginBottom: 5 }}>
					<VSCodeCheckbox
						checked={isDebugMode}
						onChange={(e: any) => setIsDebugMode(e.target.checked)}>
					...
					<p
						...
						When enabled, additional debugging information will be displayed and logged.
					</p>
				</div>
